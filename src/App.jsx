...
/* ------------------------------------------------------------------
   ...
   ------------------------------------------------------------------ */
const VIDEO_CHECKOUT_HORIZONTAL_URL = "https://www.youtube.com/embed/sHe9B5WB_VE"; // vídeo 16:9 — visão de tela
...
const WHATSAPP_NUMBER = "5581987532921"; // (81) 98753-2921
const WHATSAPP_MESSAGE =
  "Olá! Vi o projeto Via Expressa e gostaria de saber mais sobre o piloto de checkout sem fila.";
...
function WhatsAppFloatButton() {
  ...
  return (
    <a
      ...
      className="fixed bottom-5 right-5 sm:bottom-8 sm:right-8 z-50 flex items-center justify-center w-14 h-14 sm:w-16 sm:h-16 rounded-full transition-transform hover:scale-110"
      style={{
        background: "#25D366",
    ...
    >
      ...
      >
        ...
        <path d="M12.001 2C6.478 2 2 6.477 2 12c0 1.85.5 3.58 1.365 5.076L2 22l5.077-1.334A9.953 9.953 0 0012.001 22c5.523 0 10-4.477 10-10s-4.477-10-10-10zm0 18.163a8.13 8.13 0 01-4.146-1.132l-.297-.176-3.09.812.826-3.012-.194-.309A8.125 8.125 0 013.837 12c0-4.508 3.656-8.163 8.164-8.163S20.163 7.493 20.163 12 16.508 20.163 12.001 20.163z" />
      </svg>
    </a>
  );
}
